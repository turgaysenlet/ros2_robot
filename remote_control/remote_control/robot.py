...
try:
    while True:
        ...
        servo_.setTarget(0, int(speed))  #set servo_ to move to center position
        if dist_to_center < 0.5 and dist_to_center > 0:            
            servo_.setAccel(0,0)       #set servo_ 0 acceleration to 4
            servo_.setSpeed(0,0)       #set speed of servo_ 1
            servo_.setTarget(0, 6000)  #set servo_ to move to center position
